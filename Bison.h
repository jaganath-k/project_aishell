...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    _GT = 269,                     /* _GT  */
    _DGT = 270,                    /* _DGT  */
    _KW_break = 271,               /* _KW_break  */
    _KW_continue = 272,            /* _KW_continue  */
    _KW_do = 273,                  /* _KW_do  */
    _KW_done = 274,                /* _KW_done  */
    _KW_elif = 275,                /* _KW_elif  */
    _KW_else = 276,                /* _KW_else  */
    _KW_fi = 277,                  /* _KW_fi  */
    _KW_for = 278,                 /* _KW_for  */
    _KW_if = 279,                  /* _KW_if  */
    _KW_in = 280,                  /* _KW_in  */
    _KW_then = 281,                /* _KW_then  */
    _KW_time = 282,                /* _KW_time  */
    _KW_until = 283,               /* _KW_until  */
    _KW_while = 284,               /* _KW_while  */
    _LBRACE = 285,                 /* _LBRACE  */
    _BAR = 286,                    /* _BAR  */
    _DBAR = 287,                   /* _DBAR  */
    _RBRACE = 288,                 /* _RBRACE  */
